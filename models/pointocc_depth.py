...
class PointOccDepth(MVXTwoStageDetector):
    def __init__(self,
                 data_aug=None,
                 stop_prev_grad=0,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(PointOccDepth, self).__init__(pts_voxel_layer, pts_voxel_encoder,
    ...
    def forward_pts_train(self,
        ...
        t2 = time.time()
        loss_inputs = [depth_map, proj_label, voxel_semantics, mask_camera, outs]
